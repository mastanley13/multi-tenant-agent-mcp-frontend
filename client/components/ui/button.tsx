...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "btn-primary text-white shadow-lg hover:shadow-xl active:scale-[0.98]",
        destructive:
        ...
        ghost: "btn-ghost hover:bg-accent/10 hover:text-accent-foreground",
      ...
      size: {
        ...
        icon: "h-9 w-9",
        mobile: "btn-mobile rounded-lg", // Touch-friendly mobile size
      },
    },
    defaultVariants: {
      variant: "default",
